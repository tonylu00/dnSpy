...
class EmitDetachedRethrows {
    static void Main(string[] args) {
        ...
        if (moved == 0 || shared == 0) throw new Exception("Fixture did not exercise detached and shared rethrow tails");
        module.Write(args[1]);
        Console.WriteLine("Detached " + moved + " raw rethrows, including " + shared + " shared tails.");
    }
}
